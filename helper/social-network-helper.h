...
#ifndef SOCIAL_NETWORK_HELPER_H
#define SOCIAL_NETWORK_HELPER_H
...
public:
    /**
     * Create SocialNetworkHelper which will make life easier for people trying
     * to set up simulations with echos.
     *
     * \param ip The IP address of the remote udp echo server
     * \param port The port number of the remote udp echo server
     */
    SocialNetworkHelper (uint16_t port);
    
    //TUAN
    SocialNetworkHelper (uint16_t port, Ipv4Address requestedContent);
